            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                 @include('partial._message')  
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/pds_enter_pin') }}" data-parsley-validate>
                        {{ csrf_field() }}
                            ...
                            <div class="col-sm-6">
                                <input id="matricno" type="text" class="form-control" name="matricno" data-parsley-required placeholder="PDS/2015/0241">
