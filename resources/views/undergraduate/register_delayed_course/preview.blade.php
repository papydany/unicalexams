...
<div class="content container">
            <div class="page-wrapper">
                <header class="page-heading clearfix">
                    <h4 class="text-center text-primary"><b><u>PREVIEW DELAYED REGISTRATION OF COURSES</u></b></h4>
                    ...
                    <div class="breadcrumbs pull-right">
                        <ul class="breadcrumbs-list">
                            ...
                            <li class="current">Preview Delayed Registration </li>
                        </ul>
                    </div><!--//breadcrumbs-->
                </header> 
                </div>
...
@else
    <form class="form-horizontal" role="form" method="POST" action="{{ url('postDelayedCourse') }}" data-parsley-validate>
    {{ csrf_field() }}
