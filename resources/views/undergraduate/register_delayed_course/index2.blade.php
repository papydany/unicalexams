...
@section('title','Delayed Courses')
@section('content')
<div class="content container">
  <div class="page-wrapper">
   <header class="page-heading clearfix">
    <h4 class="text-center text-primary"><b><u>DELAYED REGISTRATION OF COURSES</u></b></h4>
    ...
    <div class="breadcrumbs pull-right">
        <ul class="breadcrumbs-list">
            ...
            <li class="current">Delayed Registration </li>
        </ul>
    </div><!--//breadcrumbs-->
   </header> 
        ...
        <h1 class="text-center text-danger">  {{$r}} </h1>
          ...
          @endif
            ...
            @if(!empty($rc) > 0)
              ...
              <form class="form-horizontal" role="form" method="GET" action="{{ url('previewDelayedCourse') }}" data-parsley-validate>
              {{ csrf_field() }}                     
