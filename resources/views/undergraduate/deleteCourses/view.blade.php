...
<div class="content container">
          ...
          <div class="table-responsive col-sm-12 col-md-10 col-md-offset-1">
           <p class="text-danger text-center"><b>DELETE COURSES</b></p>
            ...
            {{! $next_ss = $ss+1}}
              ...
              Contact 1
                ...
                @if(isset($creg))
                 @if(count($creg) > 0)
          <p class="text-danger text-center"><b>Select the check box to choose the couress you want to Delete</b></p>     
